...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
            ...
            var res = from emp in Emps
                      ...
                      select new
                      {
                          ...
                          LiczbaPracownikow = (from emp in Emps
                                               ...
                                               select emp).Count()  // nie wiem co z tą jedynką zrobić, podobno oracle przypisuje COUNT(1) do postaci COUNT(*), więc nie ma potrzeby robienia COUNT(1)
                      };
            foreach (var emp in res)
                Console.WriteLine(emp);
        }
        ...
        {
            bool workAs = Emps.Any(x => x.Job == "Backend programmer");
            Console.WriteLine($"Backend programmer: {workAs}");
        }
        ...
        {
            var res = (from emp in Emps
                       select emp.Salary).Aggregate((a, b) =>
                       {
                           if (a > b)
                               return a;
                           else
        ...
        {
            var res = Emps.SelectMany(x => Depts, (e, d) => new
            {             
                Emp = e,
                Dept = d
            });
